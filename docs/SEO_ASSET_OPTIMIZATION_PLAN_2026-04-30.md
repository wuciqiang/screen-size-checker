...
- 待验证：重新构建后检查 sitemap、canonical、hreflang、结构化数据和站内链接是否正常。

### 下一步待处理

- Phase 3：重写 `/hub/hdr-gaming-monitor-guide`，补充 2026 HDR 标准、DisplayHDR/True Black、Mini-LED/OLED 验证方法和真实选购判断。
